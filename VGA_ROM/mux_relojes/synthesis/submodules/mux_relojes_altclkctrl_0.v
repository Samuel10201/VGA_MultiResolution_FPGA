//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="Global Clock" DEVICE_FAMILY="Cyclone IV E" ENA_REGISTER_MODE="falling edge" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="ON" clkselect ena inclk outclk
...
module  mux_relojes_altclkctrl_0_sub
	( 
	clkselect,
	ena,
	inclk,
...
endmodule //mux_relojes_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  mux_relojes_altclkctrl_0  (
    clkselect,
    inclk0x,
    inclk1x,
    inclk2x,
...
`endif
    ...
    mux_relojes_altclkctrl_0_sub  mux_relojes_altclkctrl_0_sub_component (
                .clkselect (clkselect),
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
